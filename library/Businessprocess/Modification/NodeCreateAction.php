...
class NodeCreateAction extends NodeAction
{
    ...
    public function appliesTo(BpConfig $config)
    {
        ...
        if (! str_starts_with($name, 'kubernetes-selector:')
            && ($kubernetesNode !== null || isset($this->properties['kind'], $this->properties['uuid']))) {
    ...
    public function applyTo(BpConfig $config)
    {
        ...
        } elseif ($kubernetesNode !== null || isset($this->properties['kind'], $this->properties['uuid'])) {
            $kind = $this->properties['kind'] ?? $kubernetesNode[0];
            $uuid = $this->properties['uuid'] ?? $kubernetesNode[1];
